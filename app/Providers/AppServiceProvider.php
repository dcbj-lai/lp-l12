...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::define('is-manager-or-hr', fn($user) => $user->isManager() || $user->canApproveAnyLeaveRequest());
        ...
        Gate::define('guidance', fn($user) => $user->hasRole('guidance.admin'));
        Gate::define('is-clinic', fn($user) => $user->hasRole('clinic.admin'));
