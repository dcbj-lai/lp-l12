<x-layouts.app title="Leave Request Details">
    <div class="max-w-3xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-neutral-900 shadow-xl sm:rounded-lg p-6">
            ...
            <!-- Details -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-neutral-800 dark:text-neutral-100">
                ...
                @if ($request->status === 'pending')
                    <div
                        class="border border-emerald-200 dark:border-emerald-800
                   rounded-xl p-4 bg-emerald-50/60 dark:bg-emerald-900/10
                   space-y-3">
                        ...
                        @if ($credits)
                            <div class="space-y-2 text-sm">
                                <p>
                                    ...
                                    <span class="float-right">{{ number_format($credits->pto, 2) }}</span>
                                </p>

                                <p>
                                    <span class="font-medium">Work From Home:</span>
                                    <span class="float-right">{{ number_format($credits->wfh, 2) }}</span>
                                </p>
                            </div>
                        @else
