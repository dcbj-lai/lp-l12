<x-layouts.app>
    <div x-data="{ open: true }">
        <div x-show="open" x-transition
            class="fixed left-64 top-0 right-0 bottom-0 z-40 flex items-center justify-center bg-transparent backdrop-blur-sm">

            <div
                class="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-6 w-full max-w-lg relative border border-gray-300 dark:border-gray-700">
                ...
                <h2 class="text-2xl font-bold text-gray-100 mb-4">Leave Request Details</h2>
                <div class="text-gray-800 dark:text-gray-100 space-y-2 text-sm">
                    ...
                    <p>
                        ...
                        <span
                            ...
                            {{ $statusColors[strtolower($request->status)] ?? 'bg-gray-200 text-gray-800 dark:bg-gray-700 dark:text-gray-200' }}">
                ...
                <div class="mt-6">
                    <form action="{{ route('requests.process', $request->id) }}" method="POST" id="action-form">
                        ...
                        <textarea name="remarks" rows="2" placeholder="Remarks"
                            class="w-full text-sm border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md mt-4">{{ old('remarks', $request->remarks) }}</textarea>
