<x-layouts.app>
    <div class="max-w-4xl mx-auto p-6">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold">Import CSV - Clinic</h1>
            <p class="text-sm text-gray-600 mt-1">
                Upload a CSV file to import patient records into the Clinic system.
            </p>
        </div>
            ...
            <div class="p-5 border-b">
                ...
                <p class="text-sm text-gray-600">
                    ...
                    <span class="font-mono">
                        first_name,last_name,email,type,course,department,position
                    </span>
                </p>
                <p class="mt-1 text-xs text-gray-500">
                    Optional headers (allowed but not required):
                    <span class="font-mono">
                        emergency_contact_person,emergency_contact_number,blood_type
                    </span>
                </p>
                <p class="mt-2 text-xs text-gray-500">
                    Use <span class="font-mono">student</span> or <span class="font-mono">staff</span> for the
                    <span class="font-mono">type</span> column.
                </p>
            </div>

            <div class="p-5">
                <form action="{{ route('clinic.import-csv.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
