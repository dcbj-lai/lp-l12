                ...
                <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded p-4 bg-white dark:bg-gray-900">
                        ...
                        <div class="mt-2 flex flex-wrap items-center gap-2">
                            @if ($consultation->email_status === \App\Models\ClinicConsultation::EMAIL_STATUS_SENT)
                        ...
                        @if ($consultation->email_status === \App\Models\ClinicConsultation::EMAIL_STATUS_FAILED)
