...
<x-layouts.app title="Clinic Consultations">
    <div class="max-w-7xl mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-3 items-end">
                ...
                <div class="sm:col-span-2 xl:col-span-2">
                    ...
                    <input
                        ...
                        name="q"
                        value="{{ $q ?? request('q') }}"
                        placeholder="e.g., Mark or mark@email.com"
        ...
        <div
            x-data="{
                ...
                archiveId: null,
                returnPage: 'clinic-consultations'
            }"
                ...
                <table class="w-full table-fixed border-collapse text-sm">
                    <thead>
                        <tr class="bg-neutral-100 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-200">
                            <th class="w-[18%] border-b border-neutral-200 dark:border-neutral-700 px-3 py-3 text-left">Patient</th>
                            <th class="w-[10%] border-b border-neutral-200 dark:border-neutral-700 px-3 py-3 text-left">Type</th>
                            <th class="w-[16%] border-b border-neutral-200 dark:border-neutral-700 px-3 py-3 text-left">Time In</th>
                            <th class="w-[16%] border-b border-neutral-200 dark:border-neutral-700 px-3 py-3 text-left">Time Out</th>
                            <th class="w-[20%] border-b border-neutral-200 dark:border-neutral-700 px-3 py-3 text-left">Case Classification</th>
                            <th class="w-[20%] border-b border-neutral-200 dark:border-neutral-700 px-3 py-3 text-left">Action</th>
                        </tr>
                    </thead>
                    ...
                    <tbody class="text-neutral-800 dark:text-neutral-300 bg-white dark:bg-neutral-900">
                        @forelse($consultations as $consultation)
                            <tr class="border-b border-neutral-200 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition align-top">
                                ...
                                <td class="px-3 py-3 whitespace-normal break-words capitalize">
                                    {{ optional($consultation->patient)->type ?? '—' }}
                                </td>
            ...
            >
                ...
                <h2 class="text-lg font-semibold text-neutral-900 dark:text-white mb-3">
                    ...
                    <div class="flex flex-col-reverse sm:flex-row justify-end gap-3">
                        ...
                        <form method="POST" :action="'/clinic/consultations/' + archiveId + '/archive'" class="w-full sm:w-auto">
                            @csrf
                            @method('DELETE')

                            <input type="hidden" name="return" value="consultations">  
