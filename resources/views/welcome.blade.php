    ...
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">"Let your light shine before others, that they may
                    see your good works and glorify your Father in heaven."</p>
                <p class="justify-end">Matthew 5:16</p>
            </div>
            <div
