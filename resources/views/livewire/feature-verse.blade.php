<div x-data="{ show: true, menuOpen: false }" x-show="show"
    class="dashboard-card flex flex-col items-center justify-center relative p-4 rounded-lg shadow-lg">
    ...
    <div
        ...
        @if ($editing)
            <textarea wire:model="verse"
                class="backdrop-blur-md w-full text-center bg-transparent border border-gray-300 focus:outline-none focus:border-blue-500 rounded-md p-2 caret-gray-600 dark:caret-gray-200 font-normal text-gray-500 dark:text-gray-100"></textarea>
            <input type="text" wire:model="reference"
                class="mt-2 w-full text-center bg-transparent border-b border-gray-300 focus:outline-none focus:border-blue-500 text-sm caret-gray-600 dark:caret-gray-200 font-normal text-gray-500 dark:text-gray-100">
        @else
