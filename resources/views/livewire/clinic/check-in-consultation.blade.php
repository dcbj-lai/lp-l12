        ...
        <div>
            ...
            @if($patient->type === 'student')
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Select the current teacher (optional) then check-in to start the consultation.
                </p>
            @else
            ...
            <div>
                ...
                @else
                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        Optional: if selected, it will be saved with the consultation record.
                    </p>
                @endif
            </div>
        @else
            {{-- STAFF ONLY: Simple info block --}}
            <div class="rounded border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-4">
                <div class="text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400">
                    Staff Check-in
                </div>
                <div class="mt-2 text-sm text-gray-700 dark:text-gray-200">
                    This will record <span class="font-medium">Time In</span> and enable the consultation form.
                    No teacher selection is required.
                </div>
