<x-layouts.app title="Create Student Client">
    <div class="max-w-6xl mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Create Student Client</h1>
                <p class="mt-1 text-sm text-neutral-600 dark:text-neutral-400">Add a student record for Guidance consultations.</p>
            </div>
        ...
        <form method="POST" action="{{ route('guidance.clients.store') }}"
            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div class="md:col-span-2 rounded-lg border border-neutral-200 p-4 dark:border-neutral-700">
                    <label class="flex items-start justify-between gap-4">
                        ...
                        <input name="is_under_accessibility" type="checkbox" value="1" @checked(old('is_under_accessibility'))
                ...
                <div>
                    ...
                    <input id="blood_type" name="blood_type" type="text" maxlength="10" value="{{ old('blood_type') }}" placeholder="e.g., O+"
                           class="w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-neutral-900 focus:ring-2 focus:ring-blue-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white">
                </div>
                <div>
                    ...
                    <input id="emergency_contact_person" name="emergency_contact_person" type="text" value="{{ old('emergency_contact_person') }}"
                           class="w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-neutral-900 focus:ring-2 focus:ring-blue-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white">
                </div>
                <div class="md:col-span-2">
                    ...
                    <input id="emergency_contact_number" name="emergency_contact_number" type="text" inputmode="tel" value="{{ old('emergency_contact_number') }}"
                           class="w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-neutral-900 focus:ring-2 focus:ring-blue-500 dark:border-neutral-600 dark:bg-neutral-800 dark:text-white">
                </div>
            </div>
            ...
            <div class="mt-7 flex flex-col-reverse gap-3 sm:flex-row">
                ...
                <button type="submit" class="inline-flex items-center justify-center rounded-md bg-blue-600 px-5 py-2 font-semibold text-white hover:bg-blue-700">Create</button>
            </div>
        </form>
    </div>
</x-layouts.app>